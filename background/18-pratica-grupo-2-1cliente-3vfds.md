...
**Para cada VFD**, crie um fluxo de leitura + decodificação (use o function da Prática 6 [16-pratica-vfd7-nodered.md], adaptando os IPs).
...
- **[Prática Grupo 3 — 3 clientes, 3 VFDs](19-pratica-grupo-3-3clientes-3vfds.md)**: cada aluno controla seu próprio VFD, mas vê todos.
- **[Prática Grupo 4 — Mini-planta integrada](20-pratica-grupo-4-mini-planta.md)**: papéis distintos com 2 VFDs + 1 medidor.
