...
- **[Prática 2 — EM3P com Python](12-pratica-em3p-python.md)**: automatize o que você fez manualmente.
- **[Prática 3 — EM3P com Node-RED](13-pratica-em3p-nodered.md)**: construa um dashboard visual.
- **[Prática 4 — VFD7 com EasyModbusTCP](14-pratica-vfd7-easymodbus.md)**: controle um inversor de frequência.
