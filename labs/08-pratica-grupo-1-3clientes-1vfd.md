...
- **[Prática Grupo 2 — 1 cliente, 3 VFDs](18-pratica-grupo-2-1cliente-3vfds.md)**: orquestração centralizada.
- **[Prática Grupo 3 — 3 clientes, 3 VFDs](19-pratica-grupo-3-3clientes-3vfds.md)**: operação distribuída independente.
- **[Prática Grupo 4 — Mini-planta integrada](20-pratica-grupo-4-mini-planta.md)**: 2 VFDs + 1 medidor com papéis distintos.
